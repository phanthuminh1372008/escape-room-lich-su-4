let puzzles=[
  ...
  {id:2,type:"image",content:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Quang_Trung.jpg/300px-Quang_Trung.jpg",correct:true,feedbackCorrect:"Đúng! Đây là Quang Trung.",feedbackWrong:"Sai! Đây là Quang Trung."},
  {id:3,type:"fill",question:"Quang Trung đại phá ...... quân Thanh",answer:"20 vạn",feedbackCorrect:"Chúc mừng! Bạn nhận 1 ngọn đuốc.",feedbackWrong:"Sai rồi! Đáp án: 20 vạn",item:true}
];
...
function render(){
  ...
  puzzles.forEach(p=>{
    ...
    if(p.type==="video"){
      ...
      html+=`<img src="${p.content}" alt="Hình ảnh câu hỏi"><br>
      <button onclick="checkChoice(${p.id},true)">Đúng</button>
      <button onclick="checkChoice(${p.id},false)">Sai</button>`;
    } else if(p.type==="fill"){
